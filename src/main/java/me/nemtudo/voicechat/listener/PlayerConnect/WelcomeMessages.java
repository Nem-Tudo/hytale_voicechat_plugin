...
/**
 * Handles player connect event and welcome messages
 */
public class WelcomeMessages {
    ...
    public WelcomeMessages(VoiceChat plugin, VersionCheckService versionCheckService) {
        this.plugin = plugin;
    ...
    private void scheduleVersionWarning(PlayerRef playerRef, Player player) {
        ...
        HytaleServer.SCHEDULED_EXECUTOR.schedule(() -> {
            versionCheckService.sendVersionWarningMessagesToPlayer(playerRef);
